...
samplesDef = {
    ...
    'mcNom'  : tnpSamples.datasets['DYJetsToLL_M-50_TuneZ2Star_jenny'].clone(),
    'mcAlt'  : tnpSamples.datasets['DYJetsToLL_M-50_TuneZ2Star_jenny'].clone(),
    'tagSel' : tnpSamples.datasets['DYJetsToLL_M-50_TuneZ2Star_jenny'].clone(),
}
