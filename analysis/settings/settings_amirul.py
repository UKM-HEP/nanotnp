...
samplesDef = {
    'data'   : tnpSamples.datasets['Run2012A_SingleElectron'].clone(),
    'mcNom'  : tnpSamples.datasets['DYJetsToLL_M-50_TuneZ2Star_amirul'].clone(),
    'mcAlt'  : tnpSamples.datasets['DYJetsToLL_M-50_TuneZ2Star_amirul'].clone(),
    'tagSel' : tnpSamples.datasets['DYJetsToLL_M-50_TuneZ2Star_amirul'].clone(),
}
