...
run2012b_electron = {
    'Run2012B_SingleElectron' : tnpSample('Run2012B_SingleElectron', opendataDir + 'Run2012B_SingleElectron_trimmed/Run2012B_SingleElectron.root', lumi = 4.43 ),
    'DYJetsToLL_M-50_TuneZ2Star' : tnpSample('DYJetsToLL_M-50_TuneZ2Star', opendataDir + 'DYJetsToLL_M-50_TuneZ2Star_trimmed/DYJetsToLL_M-50_TuneZ2Star.root', isMC = True, nEvts =  -1 )
}

run2012c_electron = {
    'Run2012C_SingleElectron' :	tnpSample('Run2012C_SingleElectron', opendataDir + 'Run2012C_SingleElectron_trimmed/Run2012C_SingleElectron.root', lumi = 1.0 ),
    'DYJetsToLL_M-50_TuneZ2Star' : tnpSample('DYJetsToLL_M-50_TuneZ2Star', opendataDir + 'DYJetsToLL_M-50_TuneZ2Star_trimmed/DYJetsToLL_M-50_TuneZ2Star.root', isMC = True, nEvts =  -1 )
}
...
run2012c_muon = {
    'Run2012C_SingleMu' : tnpSample('Run2012C_SingleMu', opendataDir + 'Run2012C_SingleMu_trimmed/Run2012C_SingleMu.root', lumi = 1.0 ),
    'DYJetsToLL_M-50_TuneZ2Star' : tnpSample('DYJetsToLL_M-50_TuneZ2Star', opendataDir + 'DYJetsToLL_M-50_TuneZ2Star_trimmed/DYJetsToLL_M-50_TuneZ2Star.root', isMC = True, nEvts =  -1 )
}
